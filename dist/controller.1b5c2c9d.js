...
})({"10cc41c9d8b447677e09ab0f3cebbb9a":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "1b5c2c9d8b8c847ccd36efaf09d2b5ae"; /* global HMR_HOST, HMR_PORT, HMR_ENV_HASH */
...
},{}],"eb1edab94c864275c752648564408fe3":[function(require,module,exports) {
require('./bundle-manifest').register(JSON.parse("{\"cd36efaf09d2b5ae\":\"controller.1b5c2c9d.js\",\"b7a0758ac7cdfbea\":\"icons.3e8bef10.svg\"}"));
...
const loadRecipe = async function (id) {
  try {
    const data = await (0, _helpers.getJSON)(`${_config.APT_URL}/${id}`);
    const {
      recipe
    } = data.data;
    state.recipe = {
...
const loadSearchResult = async function (query) {
  try {
    ...
    const data = await (0, _helpers.getJSON)(`${_config.APT_URL}?search=${query}`);
...
},{"./View.js":"f776c090b0b233bdc806fc66c7d180d6","url:../../img/icons.svg":"7ca62492466581b2a045bd53f3e08b6c","fracty":"300cd7d834d4db2da74f6c56b657817b"}],"f776c090b0b233bdc806fc66c7d180d6":[function(require,module,exports) {
"use strict";
...
},{"url:../../img/icons.svg":"7ca62492466581b2a045bd53f3e08b6c"}],"7ca62492466581b2a045bd53f3e08b6c":[function(require,module,exports) {
module.exports = require('./bundle-url').getBundleURL() + require('./relative-path')("cd36efaf09d2b5ae", "b7a0758ac7cdfbea");
